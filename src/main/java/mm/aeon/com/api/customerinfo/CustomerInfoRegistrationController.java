...
public class CustomerInfoRegistrationController {
	...
	public CheckMemberInfoResDto checkMember(@RequestBody CheckMemberInfoReqDto checkMemberInfoReqDto) {
	...
	public OTPInfoResDto sendOtp(@RequestBody OTPInfoReqDto otpInfoReqDto) throws JSONException, IOException {
		...
		// JsonHeaderDto jsonHeaderDto = connectURL(phoneNo, randomNumber);

		// if (jsonHeaderDto != null) {
	...
	private JsonHeaderDto connectURL(String phoneNo, String otpCode) throws IOException, JSONException {
		...
		String url = CommonConstants.MAIN_URL + CommonConstants.PHONE_URL + CommonConstants.PHONE_95 + phoneNo + CommonConstants.USER_NAME_URL + CommonConstants.PASSWORD_URL
				+ CommonConstants.UNICODE_URL + CommonConstants.MESSAGE_URL;

		String message = "AEON Member OTP Code : " + otpCode;

		HttpClient client = HttpClientBuilder.create().build();
		HttpGet request = new HttpGet(url + URLEncoder.encode(message, "UTF-8") + CommonConstants.PROJECT_ID_URL);
